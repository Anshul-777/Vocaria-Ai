        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0 mb-2">
          <div>
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-500 animate-text-pan" style={{ fontFamily: 'Instrument Serif, serif' }}>
                Voice Studio
              </h1>
            </div>
