    ...
    <div className="w-full space-y-6 pb-12">
      <Reveal>
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3"><Activity className="w-6 h-6 text-gray-800" /><h1 className="text-3xl md:text-4xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-rose-500 to-pink-500 animate-text-pan" style={{ fontFamily: 'Instrument Serif, serif' }}>Live Detection</h1></div>
