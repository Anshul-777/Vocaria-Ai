...
async def send_verification_email(email: str, name: str, token: str):
    verify_url = f"https://app.vocaria.ai/verify-email?token={token}"
    subject = "Verify your Vocaria account"
    body = f"""
Hi {name},

Welcome to Vocaria! Please verify your email address to activate your account.
...
async def send_password_reset_email(email: str, name: str, token: str):
    reset_url = f"https://app.vocaria.ai/reset-password?token={token}"
    subject = "Reset your Vocaria password"
    body = f"""
Hi {name},
