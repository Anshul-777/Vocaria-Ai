"""
Vocaria Platform - Main FastAPI Application
...
from app.routers import (
    ...
    quality, benchmarks, streaming, agent
)
...
app = FastAPI(
    title="Vocaria API",
    description="""
    ## Vocaria: Enterprise Voice AI Platform
...
app.include_router(agent.router,         prefix=f"{API_PREFIX}/agent",         tags=["Voice Agent"])
